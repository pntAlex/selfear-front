...
// const URL =
//     "https://res.cloudinary.com/notaln/image/upload/v1730567225/fluid_uv_75fe24d484.webp";
...
<template>
    <!-- <section :class="`${ROOT_CLASS} column-border column-border-gray`">
        ...
        <NuxtImg
            preset="full"
            data-scroll-scale="1.5"
            data-scroll-start="0%"
            data-scroll-end="40%"
            :class="`${ROOT_CLASS}__image`"
            :src="home.data.picture.url"
            :alt="home.data.picture.alternativeText"
        />
    </section> -->
</template>
