...
const _initScrollAnimations = () => {
  document.querySelectorAll("[data-scroll-x], [data-scroll-y], [data-scroll-top], [data-scroll-bottom], [data-scroll-scale], [data-scroll-alpha], [data-scroll-speed]").forEach((el) => {
    $gsap.to(el, {
